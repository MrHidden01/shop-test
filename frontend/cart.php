...
$ids='';
              ...
              //  echo implode(',',$_SESSION['products']);
                ...
                echo Html::start_div('col-xs-12 col-lg-3 pull-right');
                echo Html::start_div('widgetbox');
                echo Html::start_div('headarea');
                echo Html::h4('دسته ها');
                echo Html::end_div();
                echo Html::start_div('contentarea');
